        ...
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Button 
              variant="outline" 
              size="sm" 
              className="flex items-center gap-1 bg-white/10 hover:bg-white/20 text-white border-white/30 backdrop-blur-sm mr-2"
              asChild
            >
              <Link to="/admin">
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-2 py-4 bg-studio-blue rounded-lg animate-fade-in shadow-lg">
            <nav className="flex flex-col space-y-4">
              ...
              <Link
                to="/admin"
                className="text-white px-4 py-2 hover:bg-studio-darkBlue rounded-md flex items-center gap-2"
                onClick={toggleMenu}
              >
                <User className="w-4 h-4" />
                Admin
